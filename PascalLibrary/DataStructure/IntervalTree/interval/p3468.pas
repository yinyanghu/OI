program p3468; //pku 3468
const maxn=100000;
      root=1;
var key,tot:array[1..maxn*4] of int64;
    left,right:array[1..maxn*4] of longint;
    a:array[1..maxn] of longint;
    i,n,m,x,y,delta:longint;
    ch:char;
procedure init;
 begin
...
function getsum(k,l,r:longint):int64;
 var mid:longint;
 begin

...
{
	area:=point[stack[top]].x * point[stack[1]].y - point[stack[1]].x * point[stack[top]].y;
	for i:=2 to top do area:=area + (point[stack[i - 1]].x * point[stack[i]].y - point[stack[i - 1]].y * point[stack[i]].x);
	area:=area / 2;
}